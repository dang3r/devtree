      ...
      <div className="prose prose-blue max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <strong className="text-blue-600">substantially equivalent</strong> to a previously approved device.
          </p>
          <p className="text-gray-700 mb-4">
            By demonstrating substantial equivalence to a <strong>predicate device</strong> (an already-cleared device),
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                <li><strong>Regex matching:</strong> Fast pattern matching for standard K-number formats</li>
                <li><strong>AI extraction:</strong> Claude Code processes PDFs (including images) to find predicates missed by regex</li>
                <li><strong>Human overrides:</strong> Manual corrections for edge cases and errors</li>
              </ul>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
            <li>
              <strong>Nodes:</strong> Each node represents a 510(k) device, color-coded by risk class:
              <ul className="list-circle list-inside ml-6 mt-1 space-y-1">
                <li><span className="text-red-600 font-semibold">Red</span> = Class III (High Risk)</li>
                <li><span className="text-amber-600 font-semibold">Amber</span> = Class II (Moderate Risk)</li>
                <li><span className="text-green-600 font-semibold">Green</span> = Class I (Low Risk)</li>
              </ul>
            </li>
            <li>
              <strong>Edges:</strong> Arrows point from a new device to its predicate(s), showing the
              "is substantially equivalent to" relationship
            </li>
            <li>
              <strong>Layouts:</strong> View as a hierarchical graph (tree-like) or timeline (chronological by decision date)
            </li>
          </ul>
        </section>
